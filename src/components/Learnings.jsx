        ...
        <div className="bg-slate-200">
            <section className="bg-slate-100 dark:bg-gray-900">
                <div className="container mx-auto px-6 py-10">
                    ...
                    <div>
                        <img className="h-40 w-full rounded-lg object-cover " src="./public/assets/exptest-pic.png" alt="Exploring The Application Screenshot" />
...
functionalities and the technologies employed.</p>
                    ...
                    <div>
                        <img className="h-40 w-full rounded-lg object-cover" src="./public/assets/testplan-pic2.png" alt="Test Plan Screenshot" />
...
achieve the best result.</p>
                    ...
                    <div>
                        <img className="h-40 w-full rounded-lg object-cover" src="./public/assets/bugreport-pic.png" alt="Screenshot of a Bug Report" />
...
reported bugs, and validated implemented fixes.</p>
                    ...
                    <div>
                        <img className="h-40 w-full rounded-lg object-cover" src="./public/assets/testexecution-pic.webp" alt="Text Execution Art Screenshot" />
...
applications.</p>
                    ...
                    <div>
                        <img className="h-40 w-full rounded-lg object-cover" src="./public/assets/smoketesting.webp" alt="Smoke Testing Art Screenshot" />
...
functionalities.</p>
                    ...
                    <div>
                        <img className="h-40 w-full rounded-lg object-cover" src="./public/assets/issue-isolation-pic.png" alt="Issue Isolation Screenshot" />
