        ...
        <div>
            <div className='flex justify-center'>
                <div className='flex-col text-center p-9 max-w-sm'>
                    <h1 className='font-bold text-2xl lg:text-3xl'>Gerard Nicolas</h1>
                    <h4 className='mt-1 mb-5 text-xs font-semibold'>BS - Information Systems</h4>
                    <p className='text-xs'>As of now my current aspiration is to become a Front End Developer, 
